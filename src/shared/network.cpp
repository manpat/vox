...
std::map<u32, std::string> packetNames {
	// {ID_REMOTE_DISCONNECTION_NOTIFICATION, "ID_REMOTE_DISCONNECTION_NOTIFICATION"},
	// {ID_REMOTE_NEW_INCOMING_CONNECTION, "ID_REMOTE_NEW_INCOMING_CONNECTION"},
	...
	{ID_REMOTE_CONNECTION_LOST, "ID_REMOTE_CONNECTION_LOST"},
